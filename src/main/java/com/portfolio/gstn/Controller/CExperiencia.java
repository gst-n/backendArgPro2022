...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){
        ...
        ExperienciaLaboral experiencia = new ExperienciaLaboral(dtoexp.getNombreE(),dtoexp.getDescripcionExp());
